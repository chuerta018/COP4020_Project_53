...
class TestScanner_starter {
	...
	@Test
	void test00() throws PLCException {
		String input = """
				void d(){}
				""";
	...
	@Test
	void test1001() throws PLCException {
		String input = """
				int d(int j) {}
				""";
		AST ast = getAST(input);
	...
	@Test
	void test200() throws PLCException {
		String input = """
				void prog(
				string j,
				image k){
	...
	@Test
	void test300() throws PLCException {
		String input = """
	...
	@Test
	void test400() throws PLCException {
		String input = """
				int prog() {
				int s0.
				string s1.
	...
	@Test
	void test90() throws PLCException {
		String input = """
				void p(){
				   int z.
				   while z {
	...
	@Test
	void test100() throws PLCException {
		String input = """
				image gen(){
				pixel p = [33,44,56].
				}
	...
	@Test
	void test1000() throws PLCException {
		String input = """
				string s(){
				image j.
	...
	@Test
	void test1212() throws PLCException {
		String input = """
				string s(){
				int xx = rand.
				int yy = Z.
	...
	@Test
	void test1313() throws PLCException {
